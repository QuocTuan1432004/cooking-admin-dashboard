      ...
      <table className="w-full">
        <thead>
          <tr className="border-b border-gray-200">
            ...
            {showViews && <th className="text-left py-3 px-4 font-semibold text-gray-700">Lượt xem</th>}
            {showRating && <th className="text-left py-3 px-4 font-semibold text-gray-700">Đánh giá</th>}
